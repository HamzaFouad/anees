...
from backend.api import DownloadAPI
...
class DownloadWorker(QThread):
    ...
    def run(self) -> None:
        try:
            self._api.execute(self._playlists)
    ...
    def stop(self)   -> None: self._api.stop()
    def pause(self)  -> None: self._api.pause()
    def resume(self) -> None: self._api.resume()
